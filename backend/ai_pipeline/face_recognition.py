    ...
    try:
        while cap.isOpened():
            ...
            try:
                ...
                print(f"[face_recognition] Frame {frame_idx} decode error: {ex}, skipping.")
                frame_idx += 1
                continue
...
def run_face_recognition_search(
    ...
    if not _TORCH_AVAILABLE:
        ...
        matches = _demo_face_search(video_path, reference_image_paths, camera_id, job_id, start_time, end_time, progress_cb)
    else:
